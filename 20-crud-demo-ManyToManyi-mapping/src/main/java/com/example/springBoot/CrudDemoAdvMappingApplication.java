...
public class CrudDemoAdvMappingApplication {
	...
	private void createCourseAndStudent(AppDAO appDAO) {
		...
		//create course
		Course tempCourse=new Course("Pacman-how to score million in life");
		
		//create the students
		Student tempStudent1=new Student("Shaija","Agarwal","agarwal@gmail.com");
		Student tempStudent2=new Student("John","Mary","mary@gmail.com");
